...
public class BookController {
    ...
    public String init() {
        ...
        Book book2 = new Book("The tale of two cities", "Thomas Hardy", 5500, "Newon",
                LocalDate.of(1958, 7, 17), "Romance", "https://source.unsplash.com/random/400*300/?city");

        Book book3 = new Book("Sons and Lovers", "DH Lawrence", 6900, "Thwon",
                LocalDate.of(1999, 2, 12), "Novel", "https://source.unsplash.com/random/400*300/?lovers");
